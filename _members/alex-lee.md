...
Alexandra was a Ph.D. student in the Greene Lab through [Penn’s Genomics and Computational Biology (GCB) PhD Program](https://www.med.upenn.edu/gcb/).
...
Since joining the Greene lab in 2018, her research focused on using deep learning methods to extract patterns from large-scale gene expression datasets.
She applied these methods to understand mechanisms of _P.aeruginosa_ infection.
Her goal is to develop methods that help gain insight into the complexities of disease traits.
After defending, she became a Sr. Community engagement/Biomedical data scientist at DNAnexus.
