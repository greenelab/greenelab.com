...
{% include figure.html url="/blog/ada-2.jpg" description="Visiting the Broad Institute on the first solo trip I took with our daughter, which we did via Amtrak." %}
...
{% include figure.html url="/blog/ada-3.jpg" description="Napping on the Boppy pillow." %}
...
{% include figure.html url="/blog/ada-4.jpg" description="Everything’s a toy! This cup was a big hit with me in Houston." %}
...
{% include figure.html url="/blog/ada-5.jpg" description="Car seat, stroller, Boppy in the walking-through-the-airport configuration." %}
...
{% include figure.html url="/blog/ada-6.jpg" description="Snack mix bags crinkle, and wow that is fun!" %}
...
{% include figure.html url="/blog/ada-7.jpg" description="Skyclub membership was helpful.
...
{% include figure.html url="/blog/ada-8.jpg" description="Even as our daughter has grown, the Boppy pillow remains a favorite in the air." %}
...
{% include figure.html url="/blog/ada-9.jpg" description="Speaker dinner for the Keck Center Research Conference." %}
...
{% include figure.html url="/blog/ada-10.jpg" description="Our daughter spending lunch with me at PSB." %}
